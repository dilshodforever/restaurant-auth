...
const (
	Restoranrvice_CreateRestoran_FullMethodName  = "/protos.Restoranrvice/CreateRestoran"
	Restoranrvice_DeleteRestoran_FullMethodName  = "/protos.Restoranrvice/DeleteRestoran"
	Restoranrvice_UpdateRestoran_FullMethodName  = "/protos.Restoranrvice/UpdateRestoran"
	Restoranrvice_GetByIdRestoran_FullMethodName = "/protos.Restoranrvice/GetByIdRestoran"
	Restoranrvice_GetAllRestoran_FullMethodName  = "/protos.Restoranrvice/GetAllRestoran"
)
...
func (c *restoranrviceClient) CreateRestoran(ctx context.Context, in *Restoran, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, Restoranrvice_CreateRestoran_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *restoranrviceClient) DeleteRestoran(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, Restoranrvice_DeleteRestoran_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *restoranrviceClient) UpdateRestoran(ctx context.Context, in *Restoran, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, Restoranrvice_UpdateRestoran_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *restoranrviceClient) GetByIdRestoran(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Restoran, error) {
	out := new(Restoran)
	err := c.cc.Invoke(ctx, Restoranrvice_GetByIdRestoran_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *restoranrviceClient) GetAllRestoran(ctx context.Context, in *Restoran, opts ...grpc.CallOption) (*GetAllRestorans, error) {
	...
	err := c.cc.Invoke(ctx, Restoranrvice_GetAllRestoran_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Restoranrvice_CreateRestoran_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Restoranrvice_CreateRestoran_FullMethodName,
	}
...
func _Restoranrvice_DeleteRestoran_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Restoranrvice_DeleteRestoran_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Restoranrvice_UpdateRestoran_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Restoranrvice_UpdateRestoran_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Restoranrvice_GetByIdRestoran_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Restoranrvice_GetByIdRestoran_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Restoranrvice_GetAllRestoran_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Restoranrvice_GetAllRestoran_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
