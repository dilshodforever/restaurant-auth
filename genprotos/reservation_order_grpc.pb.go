...
const (
	ReservationOrderService_CreateReservationOrder_FullMethodName  = "/protos.ReservationOrderService/CreateReservationOrder"
	ReservationOrderService_DeleteReservationOrder_FullMethodName  = "/protos.ReservationOrderService/DeleteReservationOrder"
	ReservationOrderService_UpdateReservationOrder_FullMethodName  = "/protos.ReservationOrderService/UpdateReservationOrder"
	ReservationOrderService_GetByIdReservationOrder_FullMethodName = "/protos.ReservationOrderService/GetByIdReservationOrder"
	ReservationOrderService_GetAllReservationOrder_FullMethodName  = "/protos.ReservationOrderService/GetAllReservationOrder"
)
...
func (c *reservationOrderServiceClient) CreateReservationOrder(ctx context.Context, in *ReservationOrder, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, ReservationOrderService_CreateReservationOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationOrderServiceClient) DeleteReservationOrder(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, ReservationOrderService_DeleteReservationOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationOrderServiceClient) UpdateReservationOrder(ctx context.Context, in *ReservationOrder, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, ReservationOrderService_UpdateReservationOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationOrderServiceClient) GetByIdReservationOrder(ctx context.Context, in *ById, opts ...grpc.CallOption) (*ReservationOrder, error) {
	...
	err := c.cc.Invoke(ctx, ReservationOrderService_GetByIdReservationOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationOrderServiceClient) GetAllReservationOrder(ctx context.Context, in *ReservationOrder, opts ...grpc.CallOption) (*GetAllReservationOrders, error) {
	...
	err := c.cc.Invoke(ctx, ReservationOrderService_GetAllReservationOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReservationOrderService_CreateReservationOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationOrderService_CreateReservationOrder_FullMethodName,
	}
...
func _ReservationOrderService_DeleteReservationOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationOrderService_DeleteReservationOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationOrderService_UpdateReservationOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationOrderService_UpdateReservationOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationOrderService_GetByIdReservationOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationOrderService_GetByIdReservationOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationOrderService_GetAllReservationOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationOrderService_GetAllReservationOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
