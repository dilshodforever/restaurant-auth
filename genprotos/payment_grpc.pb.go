...
func (c *paymentServiceClient) GetByIdPayment(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Payment, error) {
	out := new(Payment)
	err := c.cc.Invoke(ctx, PaymentService_GetByIdPayment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentServiceClient) GetAllPayment(ctx context.Context, in *Payment, opts ...grpc.CallOption) (*GetAllPayments, error) {
	...
	err := c.cc.Invoke(ctx, PaymentService_GetAllPayment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
