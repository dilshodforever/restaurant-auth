...
func (c *reservationServiceClient) GetByIdReservation(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Reservation, error) {
	out := new(Reservation)
	err := c.cc.Invoke(ctx, ReservationService_GetByIdReservation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) GetAllReservation(ctx context.Context, in *Reservation, opts ...grpc.CallOption) (*GetAllReservations, error) {
	...
	err := c.cc.Invoke(ctx, ReservationService_GetAllReservation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
