...
const (
	MenuService_CreateMenu_FullMethodName  = "/protos.MenuService/CreateMenu"
	MenuService_DeleteMenu_FullMethodName  = "/protos.MenuService/DeleteMenu"
	MenuService_UpdateMenu_FullMethodName  = "/protos.MenuService/UpdateMenu"
	MenuService_GetByIdMenu_FullMethodName = "/protos.MenuService/GetByIdMenu"
	MenuService_GetAllMenu_FullMethodName  = "/protos.MenuService/GetAllMenu"
)
...
func (c *menuServiceClient) GetByIdMenu(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Menu, error) {
	out := new(Menu)
	err := c.cc.Invoke(ctx, MenuService_GetByIdMenu_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *menuServiceClient) GetAllMenu(ctx context.Context, in *Menu, opts ...grpc.CallOption) (*GetAllMenus, error) {
	out := new(GetAllMenus)
	err := c.cc.Invoke(ctx, MenuService_GetAllMenu_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
